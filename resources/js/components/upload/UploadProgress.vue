<template>
    <div v-if="status.totalFiles !== undefined && status.totalFiles > 0" class="card upload-progress">
        <div class="card-body">
            <div v-if="status.totalFiles - 1 > 0" class="h1 mb-3">Uploading files, {{
                    status.totalFiles - 1
                                                                  }} pending
            </div>
            <div v-if="status.currentFile !== null">
                ...
                <div class="progress progress-sm">
                    <div :aria-valuenow="status.progress" :style="cssVars" aria-valuemax="100" aria-valuemin="0" class="progress-bar bg-blue" role="progressbar">
