...
class getid3_amr extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $info['audio']['bits_per_sample'] =
            13;   // http://en.wikipedia.org/wiki/Adaptive_Multi-Rate_audio_codec: "Sampling frequency 8 kHz/13-bit (160 samples for 20 ms frames), filtered to 200–3400 Hz"
        $info['audio']['sample_rate'] =
            8000;   // http://en.wikipedia.org/wiki/Adaptive_Multi-Rate_audio_codec: "Sampling frequency 8 kHz/13-bit (160 samples for 20 ms frames), filtered to 200–3400 Hz"
    ...
    public function amr_mode_bitrate($key)
    {
        static $amr_mode_bitrate =
            array(0 => 4750, 1 => 5150, 2 => 5900, 3 => 6700, 4 => 7400, 5 => 7950, 6 => 10200, 7 => 12200,);
        return (isset($amr_mode_bitrate[$key]) ? $amr_mode_bitrate[$key] : false);
    }
