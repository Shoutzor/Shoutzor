...
class getid3_dsf extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $info['dsf']['dsd']['dsd_chunk_size'] =
            getid3_lib::LittleEndian2Int(substr($dsfheader, $headeroffset, 8)); // should be 28
        $headeroffset += 8;
        ...
        $info['dsf']['fmt']['fmt_chunk_size'] =
            getid3_lib::LittleEndian2Int(substr($dsfheader, $headeroffset, 8));  // usually 52 bytes
        $headeroffset += 8;
        ...
        $info['dsf']['fmt']['format_version'] =
            getid3_lib::LittleEndian2Int(substr($dsfheader, $headeroffset, 4));  // usually "1"
        $headeroffset += 4;
        $info['dsf']['fmt']['format_id'] =
            getid3_lib::LittleEndian2Int(substr($dsfheader, $headeroffset, 4));  // usually "0" = "DSD Raw"
        $headeroffset += 4;
        ...
        $headeroffset += 4;
        $info['dsf']['fmt']['reserved'] =
            getid3_lib::LittleEndian2Int(substr($dsfheader, $headeroffset, 4)); // zero-filled
        $headeroffset += 4;
        ...
        $info['audio']['bitrate'] =
            $info['audio']['bits_per_sample'] * $info['audio']['sample_rate'] * $info['audio']['channels'];
